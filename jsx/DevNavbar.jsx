...
"></span><span className="badge badge-success navbar-badge">9</span></a>
                  ...
                  <li className="dropdown">
                    <a href="#Actions" className="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><img src="../img/profile.jpg" className="img-responsive" alt="Cinque Terre"></img><span>Peter</span></a>               
                    <ul className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
